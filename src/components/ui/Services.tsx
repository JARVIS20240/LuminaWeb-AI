...
export default function Services() {
  ...
  return (
    <section id="services" className="py-40 px-6 lg:px-12 bg-background relative overflow-hidden">
        ...
        <div className="mb-24 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            ...
            <p className="text-muted max-w-lg text-lg leading-relaxed">
              You’ll get more than just great design - you’ll get results that help your business scale.
            </p>
          </div>
        </div>
